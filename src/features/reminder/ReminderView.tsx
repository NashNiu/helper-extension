      ...
      <ul>
        {items.map((r) => (
          <li key={r.id} className="flex items-center gap-3 border-b border-line px-4 py-3">
            <span className="flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-md bg-accent-soft text-accent-ink">
              <BellIcon />
            </span>
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm text-ink">{r.message}</p>
