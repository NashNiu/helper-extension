...
export const LOCAL_TIMER_PRESETS: Timer[] = [
  ...
  { id: -4, name: "52/17 计时", duration_seconds: 52 * 60, type: "focus", is_preset: true, created_at: "" },
  { id: -5, name: "90 分钟计时", duration_seconds: 90 * 60, type: "focus", is_preset: true, created_at: "" },
